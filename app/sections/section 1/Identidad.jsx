  ...
  return (
    <div id='identity' className="h-auto w-full flex items-center justify-center">
      <div className='h-auto w-full md:w-[80%] flex justify-start flex-col text-[var(--bg)] bg-white relative z-[1] px-7 p-6'>
        ...
        <div className="h-auto flex items-center flex-col justify-start w-full md:px-10 2xl:px-24 mt-6 md:mt-0 2xl:mt-4">
        ...
        <div className="h-auto flex items-center justify-start w-full flex-col md:px-10 2xl:px-24 md:flex-row">
          <div className="h-[220px] md:order-2 flex-col p-6 md:p-0 md:h-[240px] md:w-[450px] 2xl:h-[400px] 2xl:w-[660px] w-full text-white rounded my-10 flex items-center justify-center">
