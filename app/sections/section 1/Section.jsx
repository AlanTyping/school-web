...
const SectionOne = () => {
  return (
    <div id='section-one' className='h-auto md:h-[720px] w-full md:w-[80%] text-[#001d3d] relative z-[1] px-10 md:px-6 p-6'>
      ...
      <div className="h-auto flex items-center justify-start w-full flex-col md:flex-row">
        <div className="h-[180px] flex-col p-6 md:h-[230px] w-[380px] bg-[#d48611] rounded my-10 flex items-center justify-center">
        ...
        <p className="md:w-[55%] p-6">Lorem ipsum dolor sit amet consectetur, adipisicing elit.
          Ducimus ut soluta accusantium voluptate quibusdam, nesciunt eum, quam ab eveniet vero magnam exercitationem,
