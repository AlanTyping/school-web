  ...
  return (
    <div className="h-auto w-full flex items-center justify-center">
      <div id='section-one' className='h-auto w-full lg:w-[80%] text-[#001d3d] bg-white relative z-[1] px-10 lg:px-6 p-6'>
        ...
        <div className="h-auto flex items-center flex-col justify-center w-full mt-10 lg:px-[80px]">
        ...
        <div className="h-auto flex items-center justify-center w-full flex-col lg:flex-row">
          ...
          <div className="h-[180px] flex-col p-6 lg:h-[230px] w-[380px] bg-[#b3b3b3] text-white rounded my-10 flex items-center justify-center">
