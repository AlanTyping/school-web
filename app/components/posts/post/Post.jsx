...
export const Post = ({ fecha, titulo, descripcion, link, imagen, i }) => {
  return (
    <div className={`${i > 2 && 'hidden'} mx-5 w-[80%] h-[400px] overflow-y-scroll flex flex-col max-w-[400px] pb-4 pt-8 min-w-[325px] items-center text-white bg-[#1a3275] my-5 rounded`}>
