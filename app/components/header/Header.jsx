...
const Header = () => {
  return (
    <header className={`h-[110px] border-b-[8px] border-[#004999] bg-[var(--bg)] md:bg-[#e4e4e4] md:border-none md:h-[85px] md:border-b-[4px] 2xl:h-[110px] 2xl:text-[1.6rem] md:absolute md:top-0 text-white flex justify-start relative w-full z-[1]`}>
      <Link className='h-full flex flex-col items-center relative ml-10 md:ml-[6vw]' href='/'>
        ...
        <div className='h-full w-full flex items-center justify-center text-white md:text-[var(--bg)] text-[1.2rem] 2xl:text-[1.5rem]'>
