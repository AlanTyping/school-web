...
const Header = () => {
  return (
    <header className={`h-[110px] border-b-[8px] border-[#004999] bg-[#001d3d] md:bg-[#001d3d3d] md:border-none md:h-[85px] md:border-b-[4px] 2xl:h-[110px] 2xl:text-[1.6rem] md:absolute md:top-0 text-white flex justify-start relative w-full z-[1]`}>
