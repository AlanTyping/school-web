...
const DynamicHeader = () => {
  ...
  return (
    <motion.header className={`${hidden && 'header-hidden'} h-[70px] border-b-[4px] border-[#004999] md:h-[80px] 2xl:h-[110px] 2xl:text-[1.6rem] bg-[#001d3d] text-white flex justify-start top-0 fixed w-full z-[1]`}>
